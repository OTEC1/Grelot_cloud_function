...
import {AuthUserSession,RegisterNewUser,AuthUserRequest,AuthUserRequestSize,UserFund,ManageUserAcct,Vault,JoinGroupCheck,WithdrawfundsFromGroup,GetListOfCreatedGroup,ViewGroup,LoadActiveGroup,LoadInactiveGroup, Group_action, User_action} from './controllers/Cravetech';
...
Cravetech.post("/ViewGroup",ViewGroup);
